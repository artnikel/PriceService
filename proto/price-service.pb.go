...
func (x *Shares) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Shares) ProtoMessage() {}

func (x *Shares) ProtoReflect() protoreflect.Message {
	mi := &file_price_service_proto_msgTypes[0]
...
// Deprecated: Use Shares.ProtoReflect.Descriptor instead.
func (*Shares) Descriptor() ([]byte, []int) {
	return file_price_service_proto_rawDescGZIP(), []int{0}
}

func (x *Shares) GetCompany() string {
	if x != nil {
		return x.Company
	}
	return ""
...
func (x *Shares) GetPrice() float64 {
	if x != nil {
		return x.Price
	}
	return 0
...
type SubscribeResponse struct {
	...
	Shares []*Shares `protobuf:"bytes,1,rep,name=Shares,proto3" json:"Shares,omitempty"`
}
...
func (x *SubscribeResponse) GetShares() []*Shares {
	if x != nil {
		return x.Shares
	}
	return nil
...
var file_price_service_proto_rawDesc = []byte{
	...
	0x53, 0x68, 0x61, 0x72, 0x65, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e,
	...
	,
	...
	0x61, 0x64, 0x69, 0x6e, 0x67, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_price_service_proto_depIdxs = []int32{
	0, // 0: proto.SubscribeResponse.Shares:type_name -> proto.Shares
